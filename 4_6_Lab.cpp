...
class labtop : public computing_device, public telephone
{
public:
    string name, os;
    labtop(string _name, processor _cpu, float _ram, input_device _keybaord, string _os)
    {
        name = _name;
        cpu = _cpu;
        ram_capacity = _ram;
    ...
    void print()
    {
        cout << name << " has [" << processing_power() << "] " << "with [" << input.name << "] input" << endl;
    }
};
class smartphone : public computing_device, public telephone
{

public:
string name;
    smartphone(string _name,processor _cpu,float _ram,input_device _input,string _network){
        name = _name;
        cpu = _cpu;
        ram_capacity = _ram;
        input = _input;
    ...
    void print(){
       ...
       string brand = cpu.brand;
        ...
        cout <<"] with ["<< network << "] network and running at ["<< processing_power()<<"] power"<< endl;
    }
};
