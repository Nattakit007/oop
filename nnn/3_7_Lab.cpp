...
public:
    ...
    media(string _name, string _author, int _lenght, int timepl)
    {
        name = _name;
        author = _author;
        length = _lenght;
...
public:
    ...
    movie(string _name, string _author, int _length, int time, string _director, string _actor) : media(_name, _author, _length, time)
    { // 5 parameter constructor
        director = _director;
        main_actor = _actor;
    }
...
public:
    ...
    episode(string _name, string _author, int _length,int time, int ep_num, string ep_name) : media(_name, _author, _length,time)
    { // 5 parameter constructor
        episode_number = ep_num;
        episode_name = ep_name;
...
public:
    podcast(string _name, string _author, int _lenght, string ep_name) : media(_name, _author, _lenght)
    {
    ...
    void print_podcast()
    {
        cout << "now we playing " << name << " From" << epname << "podcast station " << "at " << get_playing_sec() << "sec"<<endl;
    }
};
